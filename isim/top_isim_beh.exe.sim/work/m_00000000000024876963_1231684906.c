...
#endif
static const char *ng0 = "D:/ISE Project/COD/Lab05_CPU/PC_Module.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
...
LAB23:    memcpy(t141, t58, 8);

LAB24:    memset(t169, 0, 8);
    t170 = (t141 + 4);
...
LAB90:    t295 = (t0 + 5480);
    ...
    t299 = *((char **)t298);
    memcpy(t299, t3, 8);
    xsi_driver_vfirst_trans(t295, 0, 31);
    t300 = (t0 + 5352);
    *((int *)t300) = 1;
...
LAB30:    memcpy(t101, t73, 8);

LAB31:    memset(t133, 0, 8);
    t134 = (t101 + 4);
...
LAB82:    t283 = (t0 + 3368);
    ...
    t287 = *((char **)t286);
    memset(t288, 0, 8);
    xsi_vlog_unsigned_add(t288, 32, t285, 32, t287, 32);
    goto LAB83;
...
LAB86:    xsi_vlog_unsigned_bit_combine(t3, 32, t288, 32, t294, 32);
    goto LAB90;

LAB88:    memcpy(t3, t288, 8);
    goto LAB90;
...
extern void work_m_00000000000024876963_1231684906_init()
{
	static char *pe[] = {(void *)Cont_39_0,(void *)Cont_40_1,(void *)Always_41_2,(void *)Always_51_3};
	xsi_register_didat("work_m_00000000000024876963_1231684906", "isim/top_isim_beh.exe.sim/work/m_00000000000024876963_1231684906.didat");
